    ...
    <section className="py-16 bg-gray-50">
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-xl text-gray-700 font-semibold mb-2">Présent dans toute la région Occitanie</p>
          <p className="text-lg text-gray-600">Nos équipes sont basées en Ariège</p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          >
            ...
            <p className="text-sm text-blue-600 mb-3 font-semibold">📍 Nos équipes basées ici</p>
          ...
          >
            ...
            <ul className="text-gray-600 space-y-2 text-sm mt-8">
              <li>• Toulouse</li>
              <li>• Muret</li>
              <li>• Saint-Gaudens</li>
              <li>• Colomiers</li>
