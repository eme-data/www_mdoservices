...
export function AdminControls({
  ...
  return (
    <div className="bg-slate-800 rounded-xl shadow-2xl p-6 md:p-8 mb-10 ring-1 ring-slate-700">
      <h2 className="text-2xl font-semibold mb-6 text-center text-white">Ajouter un Élément</h2>
      ...
      <div className="mt-6 border-t border-slate-700 pt-6">
        <h3 className="text-lg font-medium mb-3 text-center text-white">Importer depuis CSV</h3>
