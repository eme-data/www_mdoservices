...
export default function BitwardenDetails() {
  const handleContact = () => {
    window.location.href = "mailto:mathieu@mdoservices.fr?subject=Demande de contact MDO SERVICES - Bitwarden"
  }
      ...
      <div className="pt-24">
        ...
        <section className="hero-gradient text-white py-20">
          <div className="container mx-auto px-4">
            ...
            >
              <h1 className="text-4xl md:text-5xl font-bold mb-6">Bitwarden</h1>
              <p className="text-xl text-blue-100 max-w-3xl mx-auto mb-8">
                Gestionnaire de mots de passe sécurisé pour les entreprises
              </p>
          ...
          <div className="container mx-auto px-4">
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <SolutionCard
                ...
                description="Collaboration sécurisée"
                features={[
                  "Partage sécurisé",
                  "Gestion des accès",
              ...
              <div className="grid md:grid-cols-2 gap-8">
                ...
                >
                  ...
                  <ul className="space-y-3">
                    ...
                    <li className="flex items-center">
                      <Check className="h-5 w-5 text-blue-600 mr-2" />
                      <span>Contrôles d'accès granulaires</span>
                    </li>
                    <li className="flex items-center">
                      <Check className="h-5 w-5 text-blue-600 mr-2" />
                ...
                >
                  ...
                  <ul className="space-y-3">
                    <li className="flex items-center">
                      <Check className="h-5 w-5 text-blue-600 mr-2" />
                      <span>Console d'administration centralisée</span>
                    </li>
                    <li className="flex items-center">
                      <Check className="h-5 w-5 text-blue-600 mr-2" />
                      <span>Déploiement facile</span>
                    </li>
                    <li className="flex items-center">
                      <Check className="h-5 w-5 text-blue-600 mr-2" />
                      <span>Intégration Active Directory</span>
                    </li>
                    <li className="flex items-center">
                      <Check className="h-5 w-5 text-blue-600 mr-2" />
            ...
            <motion.div 
              ...
              transition={{ duration: 0.6 }}
            >
              <h2 className="text-3xl font-bold mb-6">Sécurisez Vos Mots de Passe d'Entreprise</h2>
              <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
                Contactez-nous pour une démonstration personnalisée de Bitwarden
              </p>
              <Button onClick={handleContact} className="premium-button text-white">
                Demander un devis
                <ChevronRight className="ml-2 h-4 w-4" />
